...
def generate_launch_description():
    ...
    pkg_navi_stack_hw = FindPackageShare('navi_stack_hw')
    default_rviz_config_path = PathJoinSubstitution([pkg_navi_stack_hw, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the navi_stack_hw package
